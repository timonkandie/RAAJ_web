...
<button class="lightbox-nav-btn lightbox-prev" aria-label="Previous Image">â€¹</button>
...
<button class="lightbox-nav-btn lightbox-next" aria-label="Next Image">â€º</button>
`;
